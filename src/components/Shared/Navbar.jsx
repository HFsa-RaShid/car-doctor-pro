...
//         <div>
//         {
//             menuItems.map((item) => <Link key={item.path} href={item.path} className="btn btn-ghost rounded-btn mx-1">{item.title}</Link>)
//         }
//     </div>
//       </ul>
//     </div>
...
//         {
//             menuItems.map((item) => <Link key={item.path} href={item.path} className=" hover:text-[#FF3811] duration:300">{item.title}</Link>)
//         }
//     </div>
//   </div>
...
//     <button className="btn btn-outline text-[#FF3811] hover:bg-[#FF3811] hover:text-[#b92f14]">Appointment</button>
//     </Link>
//   </div>
// </div>
//         </div>
